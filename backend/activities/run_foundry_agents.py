    ...
    *,
    ...
    parts.extend(
        [
            ...
            "- For qualitative change-control questions such as what changed, did the recommendation change, or compare recommendation/root cause/risk/disposition, use the Previous Recommendation Snapshot and state each requested field as changed, unchanged, or not determinable.",
            ...
            "- For multi-part questions, answer every requested part explicitly; if priorities or 2-3 next steps are requested, preserve that structure with labels such as Priority 1, Priority 2, and Priority 3.",
            ...
            "- Every `supporting_evidence` item must include `source_quote`: exact source wording that supports the fact.",
...
def _build_prompt(
    ...
    lines += [
        ...
        (
            ...
            "is not_determinable or unknown_count shows a requested action/outcome is missing or "
            "ambiguous, do not write analysis, rationale, recommendation, CAPA, or operator_dialogue "
            "as though that action/outcome happened, did not happen, was unnecessary, or was the "
            "historical pattern. "
