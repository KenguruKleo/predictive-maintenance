...
| ID | Файл | Назва | Пріоритет | Статус |
|---|---|---|---|---|
| T-020 | [T-020-cosmos-db.md](./T-020-cosmos-db.md) | Cosmos DB — схема + provisioning | 🔴 CRITICAL | 🔜 TODO |
| T-021 | [T-021-mock-data.md](./T-021-mock-data.md) | Mock data seed | 🔴 CRITICAL | 🔜 TODO |
| T-022 | [T-022-service-bus.md](./T-022-service-bus.md) | Azure Service Bus alert-queue | 🟠 HIGH | 🔜 TODO |
| T-036 | [T-036-ingestion-pipeline.md](./T-036-ingestion-pipeline.md) | Document ingestion pipeline | 🟠 HIGH | 🔜 TODO |
| T-037 | [T-037-ai-search.md](./T-037-ai-search.md) | AI Search indexes + mock docs | 🟠 HIGH | 🔜 TODO |
| T-041 | [T-041-bicep-iac.md](./T-041-bicep-iac.md) | Bicep IaC templates | 🟠 HIGH | 🔜 TODO |

## Backend / Workflow / Agents

| ID | Файл | Назва | Пріоритет | Статус |
|---|---|---|---|---|
| T-023 | [T-023-ingestion-api.md](./T-023-ingestion-api.md) | Ingestion API (POST /api/alerts) | 🔴 CRITICAL | 🔜 TODO |
| T-024 | [T-024-durable-orchestrator.md](./T-024-durable-orchestrator.md) | Durable Functions orchestrator | 🔴 CRITICAL | 🔜 TODO |
| T-025 | [T-025-research-agent.md](./T-025-research-agent.md) | Research Agent (Foundry + MCP + RAG) | 🔴 CRITICAL | 🔜 TODO |
| T-026 | [T-026-document-agent.md](./T-026-document-agent.md) | Document Agent (Foundry + templates) | 🔴 CRITICAL | 🔜 TODO |
| T-027 | [T-027-execution-agent.md](./T-027-execution-agent.md) | Execution Agent (Foundry + MCP-QMS/CMMS) | 🔴 CRITICAL | 🔜 TODO |
| T-028 | [T-028-mcp-servers.md](./T-028-mcp-servers.md) | MCP servers (cosmos-db, qms, cmms) | 🔴 CRITICAL | 🔜 TODO |
...
| T-042 | [T-042-cicd.md](./T-042-cicd.md) | GitHub Actions CI/CD | 🟠 HIGH | 🔜 TODO |
